...
<html lang="en">
 ...
 <section class="home-slider inner-page owl-carousel">
      <div class="slider-item" style="background-image: url('img/manager.jpg');width:100%;height:100%;">
        
        <div class="container">
          <div class="row slider-text align-items-center">
            <div class="col-md-7 col-sm-12 element-animate">
              <h1 style="color:#d34343; font-weight:bold;">Manager Portal</h1>
    ...
    <div class="form">
      ...
      <div class="tab-content">
        <div id="signup">   
          <h1 style="color: white;">Manager SignUp</h1>
          ...
          <div class="top-row">
           ...
           <div class="field-wrap">
            ...
            <input type="text" name="bbnum" required autocomplete="on"/>
          </div>
          ...
          <div class="field-wrap">
           ...
           <div class="field-wrap">
            ...
            <input type="text" name="phone" required Maxlength="10" Minlength="10" autocomplete="on"/>
          </div>
        ...
        <div id="login">   
          ...
          <p style="font-size:20px;" class="forgot"><a href="mreset.php">Forgot Password?</a></p>
