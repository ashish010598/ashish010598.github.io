...
if(isset($_POST) & !empty($_POST)){
	...
	$sql = "SELECT * FROM `blood_bank_manager` WHERE email = '$email'";
	...
	?>	
	<a class="btn btn-lg btn-primary btn-block" href="manager.php">LOGIN</a>
	</div>	
	</header>
	</div>
...
?>
	...
	<a class="btn btn-lg btn-primary btn-block" href="mreset.php">TRY AGAIN</a>
	</form>
<?php		
	}
}	
